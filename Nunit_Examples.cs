...
namespace DataDrivenExamples
{
    ...
    public class Nunit_Examples
    {
        ...
        [TestCase("60050", "17042", 1D, 86.02D, TestName = "Source Greater Than Destination")]
        [TestCase("22015", "30040", 50D, 802.5D, TestName = "Source Less Than Destination")]
        [TestCase("32043-5694", "30040-6941", 0.5D,  2D, TestName = "9 digit zipcodes with dashes")]
